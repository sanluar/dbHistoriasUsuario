...
--
-- Host: 127.0.0.1    Database: bd_fruver
-- ------------------------------------------------------
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='La presente tabla almacena los datos de nombre de la categoria y los identifica con un ID unico.';
...
INSERT INTO `categoria` VALUES (1,'Granos'),(2,'Vegetales'),(3,'Dulces'),(4,'Frutas'),(5,'Carnes');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='La presente tabla almacena los datos que tendra especificamente el cliente, los cuales son el genero y la edad, que estara identificado por un id, unico e irrepetible. ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `contacto` VALUES (1,236455),(2,746353),(3,928374),(4,604397),(5,613204),(6,916235),(7,583274),(8,731432),(9,341232),(10,345978),(11,340789),(12,298876),(13,767684),(14,979838),(15,222532);
...
INSERT INTO `factura` VALUES (1,1,'2019-11-17',23424,32,354533,6),(2,2,'2019-11-17',45657,31,545433,7),(3,3,'2019-11-17',45645,31,245454,8),(4,4,'2019-11-17',34565,12,243523,7),(5,5,'2019-11-17',325435,22,345435,6);
...
INSERT INTO `producto` VALUES (1,1,'Arroz','2020-06-20',15,3200,3),(2,1,'Lentejas','2020-06-20',15,4500,3),(3,1,'Frijoles','2020-06-20',12,4500,3),(4,1,'Maiz','2020-06-20',10,1500,3),(5,1,'Garbanzo','2020-06-20',10,4800,3);
...
INSERT INTO `productofactura` VALUES (1,1),(1,2),(1,3),(1,4),(1,5);
...
INSERT INTO `proveedorproducto` VALUES (7,1),(7,2),(7,3),(7,4),(7,5);
...
-- Dump completed on 2019-11-19 21:03:48
